...
for n in encodeListOfStrings:
	...
	print(encodedData, "debug77")

	with open('encodedDataMessage.csv', 'w') as f:
		# converts to a string.


		# makes the headers in the ouput file
		headerNameForNewFile = "message,\n"
		f.write(headerNameForNewFile)
		...
		# cleans the string of spaces and "" marks
